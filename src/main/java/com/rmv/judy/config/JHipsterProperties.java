...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "Judy@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "Judy API";

        private String description = "Judy API documentation";
